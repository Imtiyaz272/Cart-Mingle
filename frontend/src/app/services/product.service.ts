...
export class ProductService{
  ...
  {
      return this.http.post<any>(`${apiUrls.productServiceApi}removeItem`, {productId, userId});
  }
  ...
  search(productInput:string){
    return this.http.get(`${apiUrls.productServiceApi}search/${productInput}`)
  }
}
